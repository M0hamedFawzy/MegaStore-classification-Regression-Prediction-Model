...
not_encode_X_train_dis=train_data[['City','State','MainCategory','SubCategory','Region','Ship Mode','Segment','Order ID','Customer ID','Product ID','Product Name','Postal Code']]
...
val_accuracy = clf.score(X_val, y_val)
print("Validation Accuracy randam forest:", val_accuracy)
# Save the trained model to disk using pickle
...
# Evaluate the accuracy of the classifier on the validation set
val_accuracy = clf.score(X_val, y_val)
print("Validation Accuracy naie:", val_accuracy)
